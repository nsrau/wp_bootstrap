...
function wp_bootstrap_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'wp_bootstrap' ),
	) );
...
function wp_bootstrap_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'wp_bootstrap' ),
...
function wp_bootstrap_scripts() {
	...
	wp_enqueue_script( 'wp_bootstrap-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'wp_bootstrap-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
